...
{
    public partial class frmMegaCD : frmBase
    {
        ...
        public frmMegaCD(frmMain frm, int chipID, int zoom, MDChipParams.RF5C164 newParam, MDChipParams.RF5C164 oldParam) : base(frm)
        {
            this.chipID = chipID;
            this.zoom = zoom;
