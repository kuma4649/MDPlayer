...
{
    public partial class frmYM2413 : frmBase
    {
        ...
        public frmYM2413(frmMain frm, int chipID, int zoom, MDChipParams.YM2413 newParam, MDChipParams.YM2413 oldParam) : base(frm)
        {
            this.chipID = chipID;
            this.zoom = zoom;
            InitializeComponent();
