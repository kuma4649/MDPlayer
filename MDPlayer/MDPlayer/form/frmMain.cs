...
namespace MDPlayer.form
{
    public partial class frmMain : Form
    {
        ...
        private void OpenFormYM3526(int chipID, bool force = false)
        {
            ...
            frmYM3526[chipID] = new frmYM3526(this, chipID, setting.other.Zoom, newParam.ym3526[chipID]);
        ...
        private void OpenFormYM3812(int chipID, bool force = false)
        {
            ...
            frmYM3812[chipID] = new frmYM3812(this, chipID, setting.other.Zoom, newParam.ym3812[chipID]);
        ...
        private void OpenFormYMF262(int chipID, bool force = false)
        {
            ...
            frmYMF262[chipID] = new frmYMF262(this, chipID, setting.other.Zoom, newParam.ymf262[chipID]);
        ...
        private void playdata()
        {
            try
            {
                ...
                for (int chipID = 0; chipID < 2; chipID++)
                {
                    ...
                    for (int ch = 0; ch < 8; ch++) ResetChannelMask(EnmChip.YM2151, chipID, ch);
                    for (int ch = 0; ch < 9; ch++) ResetChannelMask(EnmChip.YM2203, chipID, ch);
