...
namespace MDPlayer.Driver.MNDRV
{
    public class devrhy
    {
        ...
        public void _ch_rhythm()
        {
            ...
            mm.Write(reg.a5 + w.len, reg.D4_B);
        ...
        {
            reg.D0_B = mm.ReadByte(reg.a1++);
            mm.Write(reg.a6 + dw.RHY_TV, reg.D0_B);
        ...
        public void _RHY_FF()
        {
            ...
            {
                reg.D1_L = 0;
                mm.Write(reg.a6 + dw.LOOP_COUNTER, reg.D1_W);
            }
            reg.D0_L = 1;
            mndrv.SUBEVENT();
