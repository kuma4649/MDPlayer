    ...
    public class devmpcm
    {
        ...
        public void _mpcm_note_keyon_pdx()
        {
            ...
            if (reg.D0_W - mm.ReadUInt16(reg.a5 + w.banktone) != 0)
            {
                ...
                reg.D4_L += reg.D5_L;
                reg.D4_L <<= 3;
                reg.D0_L = mm.ReadUInt32(reg.a2 + reg.D4_L);
                reg.D1_L = mm.ReadUInt32(reg.a2 + reg.D4_L + 4);
                reg.D0_L += reg.a2;
                if ((Int32)(reg.D0_L - reg.a2) < 0)
                {
                    _mpcm_note_keyon_set_noload();
                    return;
                }
        ...
        public void _ch_mpcm_lfo_job()
        {
            ...
            reg.D2_W += reg.D1_W;
            if ((Int16)(reg.D2_W - 0x2000) < 0) goto _ch_mpcm_lfo_end_common;
            reg.D2_W = 0x1fff;
