...
namespace MDPlayer.Driver.MNDRV
{
    public class devopn
    {
        ...
        public void _set_fnum()
        {
            ...
            mm.Write(reg.a5 + w.keycode, reg.D2_W);
            ...
            mm.Write(reg.a5 + w.tune, reg.D2_W);
        ...
        public void _fm_keyon()
        {
            ...
            reg.D0_W |= mm.ReadByte(reg.a5 + w.smask);
            reg.D1_L = 0x28;
            mndrv._OPN_WRITE3();
        ...
        public void _fm_keyon_ch3()
        {
            ...
            if ((sbyte)(reg.D0_B - 6) < 0)
            {
                mm.Write(reg.a6 + dw.CH3KOM, reg.D2_B);
            }
            else
            {
                mm.Write(reg.a6 + dw.CH3KOS, reg.D2_B);
            }
        ...
        public void _fm_echo_plus_v()
        {
            ...
            if ((sbyte)(reg.D4_B - mm.ReadByte(reg.a5 + w.volcount)) >= 0)
            {
        ...
        public void _FM_89()
        {
            ...
            reg.D5_L = (UInt32)(UInt16)reg.D5_W;
            reg.D5_L = (UInt32)((Int16)reg.D5_W / (Int16)reg.D2_W);
        ...
        public void _FM_DA()
        {
            ...
            {
                reg.D0_W = mm.ReadUInt16(reg.a1); reg.a1 += 2;
                mm.Write(reg.a5 + w.sdetune1, reg.D0_W);
            }
            ...
            {
                reg.D0_W = mm.ReadUInt16(reg.a1); reg.a1 += 2;
                mm.Write(reg.a5 + w.sdetune2, reg.D0_W);
            }
            ...
            {
                reg.D0_W = mm.ReadUInt16(reg.a1); reg.a1 += 2;
                mm.Write(reg.a5 + w.sdetune3, reg.D0_W);
            }
            ...
            {
                reg.D0_W = mm.ReadUInt16(reg.a1); reg.a1 += 2;
                mm.Write(reg.a5 + w.sdetune4, reg.D0_W);
            }
        ...
        public void _FM_DB()
        {
            ...
            {
                reg.D0_W = mm.ReadUInt16(reg.a1); reg.a1 += 2;
                mm.Write(reg.a5 + w.sdetune1, (UInt16)(mm.ReadUInt16(reg.a5 + w.sdetune1) + reg.D0_W));
            }
            ...
            {
                reg.D0_W = mm.ReadUInt16(reg.a1); reg.a1 += 2;
                mm.Write(reg.a5 + w.sdetune2, (UInt16)(mm.ReadUInt16(reg.a5 + w.sdetune2) + reg.D0_W));
            }
            ...
            {
                reg.D0_W = mm.ReadUInt16(reg.a1); reg.a1 += 2;
                mm.Write(reg.a5 + w.sdetune3, (UInt16)(mm.ReadUInt16(reg.a5 + w.sdetune3) + reg.D0_W));
            }
            ...
            {
                reg.D0_W = mm.ReadUInt16(reg.a1); reg.a1 += 2;
                mm.Write(reg.a5 + w.sdetune4, (UInt16)(mm.ReadUInt16(reg.a5 + w.sdetune4) + reg.D0_W));
            }
        ...
        public void _FM_E0()
        {
            ...
            reg.D0_B |= reg.D1_B;
            mm.Write(reg.a5 + w.pan_ampm, reg.D0_B);
            mm.Write(reg.a5 + w.reverb_pan_work, reg.D0_B);
            reg.D1_L = 0xb4;
            mndrv._OPN_WRITE4();
        }
        ...
        public void _voice_ana_set()
        {
            ...
            mm.Write(reg.a5 + w.fbcon, reg.D0_B);
            reg.D1_L = 0xb0;
            reg.D1_B += reg.D3_B;
            mndrv._OPN_WRITE2();
            reg.D0_W &= 7;
            ...
            if ((mm.ReadByte(reg.a5 + w.flag2) & 0x20) == 0)
            {
                ...
                reg.D0_W <<= 4;
                mm.Write(reg.a5 + w.smask, reg.D0_B);
            }
        ...
        public void _FM_F7_OFF()
        {
            ...
            mm.Write(reg.a5 + w.ch3tl, reg.D0_B);
            reg.D1_L = 0x27;
            if (mm.ReadByte(reg.a5 + w.ch) - 2 != 0)
            {
                _FM_F7_off_slave();
        ...
        public void _ch_fm_a_common()
        {
            ...
            if ((sbyte)reg.D1_B < 0)
            {
                ...
                mm.Write(reg.a5 + w.addvolume, reg.D0_W);
                return;
            }
            reg.D4_W = mm.ReadUInt16(reg.a4 + w_l.flag);
            if ((sbyte)reg.D4_W >= 0)
        ...
        public void _ch_fm_lfo_extend()
        {
            ...
            if (reg.D0_W != 0)
            {
                ...
                reg.D0_W = mm.ReadUInt16(reg.a4 + reg.D0_W);
                switch (reg.D0_W / 2)
                {
                    case 1:
                        _ch_fm_alfo_1();
            ...
            if (reg.D0_W - mm.ReadUInt16(reg.a5 + w.addvolume2) != 0)
            {
                mm.Write(reg.a5 + w.addvolume2, reg.D0_W);
                _ch_fm_v_calc();
            }
        ...
        public void _ex_slot_calc2()
        {
            ...
            L1a:
            if ((Int16)(reg.D1_W - reg.D4_W) >= 0)
            {
                reg.D1_W -= reg.D4_W;
                reg.D3_W += reg.D5_W;
                if ((Int16)(reg.D3_W - reg.D0_W) < 0) goto L1a;
                reg.D2_W = 0x3fff;
                goto _ex_slot_calc2_exit;
            }
            reg.D2_W += reg.D1_W;
            if ((Int16)(reg.D2_W - reg.D4_W) >= 0)
            {
                reg.D2_W -= reg.D4_W;
                reg.D3_W += reg.D5_W;
                if ((Int16)(reg.D3_W - reg.D0_W) >= 0)
                {
                    reg.D2_W = 0x3fff;
                    goto _ex_slot_calc2_exit;
                }
        ...
        public void _ch_fm_porta()
        {
            ...
            if (f != 0)
            {
                ...
                reg.D2_W = mm.ReadUInt16(reg.a5 + w.keycode3_s1);
                _ch_fm_porta_calc();
                mm.Write(reg.a5 + w.keycode2_s1, reg.D2_W);
                mm.Write(reg.a5 + w.keycode3_s1, reg.D2_W);
            }
            ...
            if (f != 0)
            {
                ...
                reg.D2_W = mm.ReadUInt16(reg.a5 + w.keycode3_s2);
                _ch_fm_porta_calc();
                mm.Write(reg.a5 + w.keycode2_s2, reg.D2_W);
                mm.Write(reg.a5 + w.keycode3_s2, reg.D2_W);
            }
            ...
            if (f != 0)
            {
                ...
                reg.D2_W = mm.ReadUInt16(reg.a5 + w.keycode3_s3);
                _ch_fm_porta_calc();
                mm.Write(reg.a5 + w.keycode2_s3, reg.D2_W);
                mm.Write(reg.a5 + w.keycode3_s3, reg.D2_W);
            }
        ...
        public void _ch_fm_porta_calc()
        {
            ...
            if ((Int16)(reg.D2_W - 0x26a) >= 0) goto _ch_fm_porta_calc_common;
            ...
            if ((Int16)(reg.D2_W - 0x4d4) < 0) goto _ch_fm_porta_calc_common;
            if ((Int16)(reg.D3_W - 0x4000) >= 0) return;
            reg.D4_W = reg.D2_W;
            reg.D4_W -= 0x4d4;
            reg.D3_W += 0x800;
            reg.D2_W = 0x26a;
        ...
        public void _ch_fm_p_5()
        {
            ...
            if (mm.ReadByte(reg.a5 + w.ch3) != 0)
            {
                mm.Write(reg.a5 + w.keycode_s1, (UInt16)(mm.ReadUInt16(reg.a5 + w.keycode_s1) + reg.D1_W));
                mm.Write(reg.a5 + w.keycode_s2, (UInt16)(mm.ReadUInt16(reg.a5 + w.keycode_s2) + reg.D1_W));
            ...
            if (mm.ReadByte(reg.a4 + w_l.count_work) == 0)
            {
                ...
                mm.Write(reg.a4 + w_l.henka_work, (UInt16)(-mm.ReadUInt16(reg.a4 + w_l.henka_work)));
            }
        }
        ...
        public void _ch_fm_p_wavememory()
        {
            ...
            if (f == 0)
            {
                if ((mm.ReadByte(reg.a4 + w.flag) & 0x20) == 0)
                {
                    _fm_p_wave_exec();
                }
                return;
        ...
        public void _ch_fm_ww()
        {
            ...
            mm.Write(reg.a4 + w_ww.rate_work, (byte)(-mm.ReadByte(reg.a4 + w_ww.rate_work)));
        }
