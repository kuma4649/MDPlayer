...
namespace MDPlayer.Driver.MNDRV
{
    public class devpsg
    {
        ...
        public void _set_psg_bend()
        {
            ...
            mm.Write(reg.a5 + w.tune, reg.D0_W);
        ...
        public void _psg_env_keyon2()
        {
            ...
            reg.D0_B = mm.ReadByte(reg.a2 + reg.D0_W);
        ...
        public void _psg_env_keyon_()
        {
            ...
            mm.Write(reg.a5 + w.e_dl, mm.ReadByte(reg.a0 + reg.D0_W));
            reg.D1_L = 0x7f;
            reg.D1_B &= mm.ReadByte(reg.a0 + reg.D0_W + 1);
            mm.Write(reg.a5 + w.e_sp, (byte)reg.D1_B);
            mm.Write(reg.a5 + w.e_lm, mm.ReadByte(reg.a0 + reg.D0_W + 2));
            mm.Write(reg.a5 + w.e_ini, mm.ReadByte(reg.a0 + reg.D0_W + 3));
        }
        ...
        public void _psg_keyoff()
        {
            ...
            reg.D0_B += 0xc;
            mm.Write(reg.a5 + w.e_p, (byte)reg.D0_B);
            mm.Write(reg.a5 + w.e_dl, mm.ReadByte(reg.a0 + reg.D0_W + 0));
            reg.D1_B=mm.ReadByte(reg.a0 + reg.D0_W + 1);
            reg.D1_B &= 0x7f;
            mm.Write(reg.a5 + w.e_sp, (byte)reg.D1_B);
            mm.Write(reg.a5 + w.e_lm, mm.ReadByte(reg.a0 + reg.D0_W + 2));
        ...
        public void _psg_env_next()
        {
            ...
            reg.D0_L = 0;
            reg.D0_B = mm.ReadByte(reg.a5 + w.e_p);
            reg.D1_B = mm.ReadByte(reg.a4 + reg.D0_W + 1);
            if ((sbyte)reg.D1_B < 0)
            {
                _psg_env_minus();
                return;
            ...
            if ((sbyte)(reg.D0_B - mm.ReadByte(reg.a5 + w.e_lm)) >= 0)
            {
                _psg_env_common();
                return;
            }
        ...
        {
            reg.D1_B &= 0x7f;
            mm.Write(reg.a5 + w.e_sp, reg.D1_B);
            reg.D0_B = mm.ReadByte(reg.a5 + w.e_ini);
            reg.D0_B -= mm.ReadByte(reg.a5 + w.e_dl);
            if ((sbyte)reg.D0_B < 0)
            {
        ...
        public void _psg_env_common()
        {
            ...
            reg.D0_B += 4;
            mm.Write(reg.a5 + w.e_p, (byte)reg.D0_B);
            mm.Write(reg.a5 + w.e_dl, mm.ReadByte(reg.a4 + reg.D0_W + 0));
            reg.D1_L = 0x7f;
            reg.D1_B &= mm.ReadByte(reg.a4 + reg.D0_W + 1);
            mm.Write(reg.a5 + w.e_sp, (byte)reg.D1_B);
            mm.Write(reg.a5 + w.e_lm, mm.ReadByte(reg.a4 + reg.D0_W + 2));
        }
        ...
        public void _PSG_89_normal()
        {
            ...
            mm.Write(reg.a4 + w_l.henka_work, reg.D1_W);
        }
        ...
        public void _PSG_A0()
        {
            ...
            reg.a0 = mm.ReadUInt32(reg.a5 + w.psgenv_adrs);
            mm.Write(reg.a5 + w.e_sw, mm.ReadByte(reg.a0 + 3));
        ...
        public void _PSG_C2()
        {
            reg.a0 = mm.ReadUInt32(reg.a5 + w.psgenv_adrs);
            reg.D0_B = mm.ReadByte(reg.a1++);
            mm.Write(reg.a5 + w.kov, reg.D0_B);
            mm.Write(reg.a0 + 14, reg.D0_B);
        }
        ...
        {
            if (mm.ReadByte(reg.a5 + w.ch) - 0x23 < 0)
            {
                mm.Write(reg.a6 + dw.NOISE_M, reg.D0_B);
            }
            else
            {
                mm.Write(reg.a6 + dw.NOISE_S, reg.D0_B);
            }
            reg.D1_L = 6;
            mndrv._OPN_WRITE2();
        }
        ...
        public void _PSG_CF()
        {
            ...
            reg.D0_B = mm.ReadByte(reg.a1++);
            reg.D0_B &= reg.D1_B;
            mm.Write(reg.a5 + w.eenv_ar, reg.D0_B);

            reg.D0_B = mm.ReadByte(reg.a1++);
            reg.D0_B &= reg.D1_B;
            mm.Write(reg.a5 + w.eenv_dr, reg.D0_B);

            reg.D0_B = mm.ReadByte(reg.a1++);
            reg.D0_B &= reg.D1_B;
            mm.Write(reg.a5 + w.eenv_sr, reg.D0_B);

            reg.D1_B = mm.ReadByte(reg.a1++);
            reg.D0_L = 0xf;
            reg.D0_B &= reg.D1_B;
            mm.Write(reg.a5 + w.eenv_rr, reg.D0_B);

            reg.D1_B = ~reg.D1_B;
            reg.D1_B >>= 4;
            mm.Write(reg.a5 + w.eenv_sl, reg.D1_B);

            reg.D0_L = 0xf;
            reg.D0_B &= mm.ReadByte(reg.a1++);
            mm.Write(reg.a5 + w.eenv_al, reg.D0_B);
        ...
        public void _PSG_F2()
        {
            ...
            reg.D1_L = 0;
            reg.D0_B = mm.ReadByte(reg.a1++);
            mm.Write(reg.a5 + w.vol, reg.D0_B);
#if false
            reg.D1_B = reg.D0_B;
            reg.D1_B++;
            reg.D0_W <<= 8;
        ...
        public void _psg_lfo()
        {
            ...
            reg.a2 = reg.a5 + w.voltable;
            reg.D0_B = mm.ReadByte(reg.a2 + reg.D0_W);
            mm.Write(reg.a5 + w.vol2, reg.D0_B);
            reg.D1_L = 8;
            mndrv._OPN_WRITE4();
        }
        ...
        public void _ch_psg_lfo_job()
        {
            ...
            if ((sbyte)reg.D1_W < 0) goto _ch_psg_a_minus;
        ...
        public void _ch_psg_a_common()
        {
            ...
            if ((sbyte)reg.D1_B < 0)
            {
                ...
                mm.Write(reg.a5 + w.addvolume, (UInt16)(mm.ReadUInt16(reg.a5 + w.addvolume) + reg.D0_W));
                return;
            }
            ...
            mm.Write(reg.a5 + w.addvolume, (UInt16)(mm.ReadUInt16(reg.a5 + w.addvolume) + reg.D1_W));
        }
        ...
        public void _ch_psg_p_common()
        {
            ...
            if ((sbyte)mm.ReadByte(reg.a6 + dw.LFO_FLAG) >= 0)
            {
                ...
                mm.Write(reg.a5 + w.addkeycode, (UInt16)(mm.ReadUInt16(reg.a5 + w.addkeycode) + reg.D1_W));
                return;
            }
        ...
        public void _ch_psg_bend()
        {
            ...
            if ((Int16)reg.D2_W >= 0)
            {
                mm.Write(reg.a4 + w_l.bendwork, (byte)(mm.ReadByte(reg.a4 + w_l.bendwork) - reg.D2_W));
                reg.D0_W -= reg.D2_W;
                mm.Write(reg.a5 + w.freqbase, (UInt16)reg.D0_W);
                reg.D0_W >>= (int)reg.D1_W;
                if ((sbyte)(reg.D0_W - mm.ReadUInt16(reg.a4 + w_l.mokuhyou)) < 0)
                {
                    _ch_psg_bend_end();
                    return;
                }
        ...
        public void _ch_psg_porta()
        {
            ...
            if ((sbyte)mm.ReadUInt16(reg.a4 + w_l.henka_work) < 0) goto _ch_psg_porta_minus;
        ...
        public void _soft2()
        {
            ...
            mm.Write(reg.a5 + w.e_srw, mm.ReadByte(reg.a5 + w.e_sr));
            mm.Write(reg.a5 + w.e_rrw, mm.ReadByte(reg.a5 + w.e_rr));
            mm.Write(reg.D0_B, mm.ReadByte(reg.a5 + w.vol));
            _soft3_0();
            return;
        ...
        public void _ex_soft2()
        {
            ...
            if (mm.ReadByte(reg.a5 + w.eenv_volume) - 15 >= 0) goto esm_ar_next;
            ...
            if ((sbyte)mm.ReadByte(reg.a5 + w.eenv_volume) < 0) goto dr_slset;
            reg.D3_B = mm.ReadByte(reg.D5_B + w.eenv_volume);
            if ((sbyte)(reg.D3_B - reg.D2_B) < 0) goto dr_slset;
            ...
            esm_dr_notx:
            mm.Write(reg.a5 + w.eenv_drc, reg.D2_B);
            goto _soft3_ok;

            dr_slset:
            mm.Write(reg.a5 + w.eenv_volume, reg.D2_B);
            mm.Write(reg.a5 + w.e_p, 3);
            goto _soft3_ok;
            ...
            reg.D2_B++;
            mm.Write(reg.a5 + w.eenv_volume, (byte)(mm.ReadByte(reg.a5 + w.eenv_volume) - reg.D2_B));
            if ((sbyte)mm.ReadByte(reg.a5 + w.eenv_volume) >= 0) goto esm_sr_exit;
            mm.Write(reg.a5 + w.eenv_volume, 0);

            esm_sr_exit:
            mm.Write(reg.a5 + w.eenv_sr, reg.D2_B);
            reg.D2_B -= 16;
            if ((sbyte)reg.D2_B >= 0) goto esm_sr_notx;
            reg.D2_B += reg.D2_B;

            esm_sr_notx:
            mm.Write(reg.a5 + w.eenv_src, reg.D2_B);
            goto _soft3_ok;
            ...
            mm.Write(reg.a5 + w.eenv_volume, (byte)(mm.ReadByte(reg.a5 + w.eenv_volume) - reg.D2_B));
            if ((sbyte)mm.ReadByte(reg.a5 + w.eenv_volume) >= 0) goto esm_rr_exit;
            mm.Write(reg.a5 + w.eenv_volume, 0);
            ...
            reg.D2_B += reg.D2_B;
            reg.D2_B -= 16;
            mm.Write(reg.a5 + w.eenv_rrc, reg.D2_B);
            goto _soft3_ok;
            ...
            reg.D2_B = mm.ReadByte(reg.a5 + w.eenv_ar);
            reg.D2_B -= 16;
            mm.Write(reg.a5 + w.eenv_arc, reg.D2_B);
            reg.D2_B = mm.ReadByte(reg.a5 + w.eenv_dr);
            reg.D2_B -= 16;
        ...
        public void _ex_soft4()
        {
            ...
            if ((sbyte)(reg.D0_B - mm.ReadByte(reg.a5 - w.e_sl)) >= 0) goto _ex_soft4_ok;
            ...
            if ((sbyte)reg.D0_B >= 0) goto _ex_soft4_ok;
            goto _ex_soft4_end;
            ...
            _ex_soft4_ok:
            mm.Write(reg.a5 + w.e_sub, reg.D0_B);
            goto _ex_soft4_volume_set;

            _ex_soft4_end:
            reg.D0_L = 0;
            mm.Write(reg.a5 + w.e_sub, reg.D0_B);
            mm.Write(reg.a5 + w.e_p, reg.D0_B);
