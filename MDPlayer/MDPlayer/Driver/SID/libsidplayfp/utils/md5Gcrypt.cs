...
namespace sidplayFpNET.libsidplayfp.utils
{
    public sealed class md5Gcrypt : iMd5
    {
        ...
        public override void append(byte[] data, int nbytes)
        {
        ...
        public override byte[] getDigest()
        {
