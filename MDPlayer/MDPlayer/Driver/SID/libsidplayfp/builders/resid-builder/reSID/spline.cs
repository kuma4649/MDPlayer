...
namespace Driver.libsidplayfp.builders.resid_builder.reSID
{
    public class spline
    {
        ...
        //public void interpolate_brute_force<PointPlotter>(double x1, double y1, double x2, double y2,
        //                 double k1, double k2,
        //                 PointPlotter plot, double res)
        //{
        //    double a = 0, b = 0, c = 0, d = 0;
        //    cubic_coefficients(x1, y1, x2, y2, k1, k2, ref a, ref b, ref c, ref d);
        ...
        // ----------------------------------------------------------------------------
        //template<class PointPlotter>
        //public void interpolate_forward_difference<PointPlotter>(double x1, double y1, double x2, double y2,
        //                    double k1, double k2,
        //                    PointPlotter plot, double res)
        //{
        //    double a = 0, b = 0, c = 0, d = 0;
        ...
        public void interpolate_forward_difference(double x1, double y1, double x2, double y2, double k1, double k2, int[] plot, double res)
        {
            ...
            for (double x = x1; x <= x2; x += res)
            {
                //plot(x, y);
                if (y < 0) y = 0;
                plot[(int)x] = (Int32)(y + 0.5);
                y += dy; dy += d2y; d2y += d3y;
            }
        }

        //template<class PointIter>
        //public double x<PointIter>(PointIter p)
        //{
        //    return p[0];
        //}

        public double x(Ptr<double[]> p)
        {
            return p.buf[p.ptr][0];
        }

        //template<class PointIter>
        //public double y(PointIter p)
        //{
        //    return (*p)[1];
        //}

        public double y(Ptr<double[]> p)
        {
            return p.buf[p.ptr][1];
        }
        ...
        // ----------------------------------------------------------------------------
        //template<class F>
        //public class PointPlotter<F> : F
        //{
        //    protected F[] f;

        //    public PointPlotter(F[] arr) : base(arr)
        //    {
        //    }

        //    public void opeKakko(double x, double y)
        //    {
