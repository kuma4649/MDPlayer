...
[同期のすゝめ]  
 ...
 ２．遅延時間は50msか100msを選びます。ここで一度[OK]を押してSCCIのみを使用する曲を再生し  
 ...
 「日和見モード」は、例えば演奏中に大きな負荷がかかり、SCCIの再生とEMUの再生が大きくずれた場合にSCCIの再生スピードを  
 調整してズレを調整する機能です。但し、遅延演奏で設定した(意図した)ズレは保ち続けます。  
