...
[概要]  
  ...
  (NRD,XGM,S98,MID,RCP,NSF,HES,SID,MDR,MDX,MND,MUC(v1.5のみ),MUB(TBD)ファイルにも対応。)  
...
[対応フォーマット]  
  ...
  .MUC (MUCOM88Windows 向けファイル)v1.5のみ  
...
[G.I.M.I.C.関連情報]  
  ...
  ・周波数について  
    ...
    設定値は以下の通りです。  
      ...
      .mnd(MNDRV)    ->  OPM:4000000Hz  OPNA:7987200Hz  
...
[同期のすゝめ]  
  ...
  環境にもよるので何が正解かはわからないのですが、私の環境での調整手順を紹介します。  
    ...
    GIMICが早い場合はGIMICのディレイ設定項目を調整します。がVersion1にはその項目はありません。  
